(() => {
  ...
  var init_kaboom = __esm({
    "node_modules/kaboom/dist/kaboom.mjs"() {
      ...
      Nt = /* @__PURE__ */ __name((i, t, l) => t in i ? rr(i, t, { enumerable: true, configurable: true, writable: true, value: l }) : i[t] = l, "Nt");
      ...
      D = /* @__PURE__ */ __name((i, t) => Ki(i, Hi(t)), "D");
      a = /* @__PURE__ */ __name((i, t) => rr(i, "name", { value: t, configurable: true }), "a");
      ...
      __name(j, "j");
      a(j, "deprecateMsg");
      T = a((i, t, l) => (...w) => (j(i, t), l(...w)), "deprecate");
      __name(ue, "ue");
      a(ue, "deg2rad");
      __name($t, "$t");
      a($t, "rad2deg");
      ...
      a(Fe, "Vec3");
      ce = a((i, t, l) => new Fe(i, t, l), "vec3");
      de = /* @__PURE__ */ __name(class {
        constructor(t, l, w) {
          b(this, "r", 255);
          b(this, "g", 255);
          b(this, "b", 255);
      ...
      __name(E, "E");
      a(E, "rgb");
      dr = a((i, t, l) => v.fromHSL(i, t, l), "hsl2rgb");
      ...
      cs = ["space", "left", "right", "up", "down", "tab", "f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9", "f10", "f11", "s"];
      Ar = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
      ls = " \u263A\u263B\u2665\u2666\u2663\u2660\u2022\u25D8\u25CB\u25D9\u2642\u2640\u266A\u266B\u263C\u25BA\u25C4\u2195\u203C\xB6\xA7\u25AC\u21A8\u2191\u2193\u2192\u2190\u221F\u2194\u25B2\u25BC !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u2302\xC7\xFC\xE9\xE2\xE4\xE0\xE5\xE7\xEA\xEB\xE8\xEF\xEE\xEC\xC4\xC5\xC9\xE6\xC6\xF4\xF6\xF2\xFB\xF9\xFF\xD6\xDC\xA2\xA3\xA5\u20A7\u0192\xE1\xED\xF3\xFA\xF1\xD1\xAA\xBA\xBF\u2310\xAC\xBD\xBC\xA1\xAB\xBB\u2591\u2592\u2593\u2502\u2524\u2561\u2562\u2556\u2555\u2563\u2551\u2557\u255D\u255C\u255B\u2510\u2514\u2534\u252C\u251C\u2500\u253C\u255E\u255F\u255A\u2554\u2569\u2566\u2560\u2550\u256C\u2567\u2568\u2564\u2565\u2559\u2558\u2552\u2553\u256B\u256A\u2518\u250C\u2588\u2584\u258C\u2590\u2580\u03B1\xDF\u0393\u03C0\u03A3\u03C3\xB5\u03C4\u03A6\u0398\u03A9\u03B4\u221E\u03C6\u03B5\u2229\u2261\xB1\u2265\u2264\u2320\u2321\xF7\u2248\xB0\u2219\xB7\u221A\u207F\xB2\u25A0";
      Or = 0;
      Ir = 3;
      hs = 0;
      ds = 3;
...
`;
      Us = /* @__PURE__ */ new Set(["id", "require"]);
      ys = /* @__PURE__ */ new Set(["add", "load", "update", "draw", "destroy", "inspect"]);
      __name(kr, "kr");
...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  function loadSynopsis() {
    ...
    onUpdate("Continue...", (continuebtn2) => {
      if (continuebtn2.isHovering()) {
        continuebtn2.scale = vec2(1.5);
      } else {
        continuebtn2.scale = vec2(1);
      }
    });
    onClick("Continue...", () => {
      txt.destroy();
